...
NEURON {
	...
	RANGE gnapbar, gnabar, gkbar, gahpbar, gl, ena, ek, el
	RANGE mp_inf, m_inf, h_inf, s_inf, zst_inf
...
PROCEDURE evaluate_fct(v(mV)) { LOCAL a,b,v2
	...
	zst_inf = 1/(1+exp((bahp-v)/gamma_ahp))
}
